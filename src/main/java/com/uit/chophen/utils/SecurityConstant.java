...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/user/login","/user/home/**", "/user/signUp","/user/resetPassword/**", "/listings/getListings", "/listings/search", "/listingCategories/**", "/listings/getPosterProfile/**"};
