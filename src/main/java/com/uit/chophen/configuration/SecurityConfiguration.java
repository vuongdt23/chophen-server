package com.uit.chophen.configuration;
...
import com.uit.chophen.filter.JwtAccessDeniedHandler;
import com.uit.chophen.filter.JwtAuthenticationEntryPoint;
import com.uit.chophen.filter.JwtAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public SecurityConfiguration(JwtAuthorizationFilter jwtAuthorizationFilter,
			...
			@Qualifier("UserProfileService") UserDetailsService userProfileService,
